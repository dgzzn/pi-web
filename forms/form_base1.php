...
<legend>Informações pessoais</legend>
    <form action="" method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control col-md-10" name="nome" id="nome" aria-describedby="helpId" placeholder="Nome completo">
        </div>
        ...
        <div class="form-group"><br>
            ...
            <input type="text" class="form-control col-md-10" name="cpf_cnpj" id="cpf_cnpj" aria-describedby="helpId" placeholder="000.000.000-00 | 00.000.000/0000-00">
    ...
    <div class="form-group">
        ...
        <input type="email" class="form-control col-md-10" name="email" id="email" aria-describedby="helpId" placeholder="exemplo@exemplo.com">
    </div>
</fieldset>
<fieldset>
    ...
    <button type="submit" class="btn btn-dark">Finalizar cadastro</button>
</form>
